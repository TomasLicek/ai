...
- Present each variant with its angle and what it does well — let see the full spread
- Note any that failed or went off-brief
- Ask user: which to keep, combine, explore further, or kill?

Don't pick a winner. The point is giving options to react to, not pre-digesting the decision.
</step>
</orchestrator_workflow>
