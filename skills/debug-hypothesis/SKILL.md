...
**Goal.** Collect raw facts. Reproduce the bug. Separate what you _know_
from what you _assume_.
...
4. Note what _does_ work. The boundary between working and broken is
   where the bug lives.
...
| Excuse                                    | Reality                                                                                              |
| ----------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| "I only have one theory"                  | You have one _favorite_ theory. Think harder. What if it's not that?                                 |
...
1. If ROOT HYPOTHESIS confirmed:
   ...
   - Stage fix and test together. Do NOT commit automatically — ask the user to confirm before committing.
